...
namespace Tunify_Platform.Migrations
{
    ...
    [Migration("20240808133725_SeedInitialData")]
            ...
            modelBuilder.Entity("Tunify_Platform.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AlbumId = 1,
                            AlbumName = "Album 1",
                            ReleaseDate = new DateTime(2024, 8, 8, 16, 37, 25, 613, DateTimeKind.Local).AddTicks(296)
                        },
                        new
                        {
                            AlbumId = 2,
                            AlbumName = "Album 2",
                            ReleaseDate = new DateTime(2024, 8, 8, 16, 37, 25, 613, DateTimeKind.Local).AddTicks(298)
                        });
                });
            ...
            modelBuilder.Entity("Tunify_Platform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Join_Date = new DateTime(2024, 8, 8, 16, 37, 25, 613, DateTimeKind.Local).AddTicks(251),
                            SubscriptionId = 1,
                            Username = "john_doe"
                        },
                        new
                        {
                            ...
                            Join_Date = new DateTime(2024, 8, 8, 16, 37, 25, 613, DateTimeKind.Local).AddTicks(267),
                            SubscriptionId = 2,
                            Username = "jane_doe"
                        });
                });
