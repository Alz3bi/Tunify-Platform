...
namespace Tunify_Platform.Migrations
{
    ...
    [Migration("20240822123122_IentityImplemntation")]
    partial class IentityImplemntation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tunify_Platform.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlbumName = "Album 1",
                            ArtistId = 1,
                            ReleaseDate = new DateTime(2024, 8, 22, 15, 31, 22, 172, DateTimeKind.Local).AddTicks(7654)
                        },
                        new
                        {
                            AlbumId = 2,
                            AlbumName = "Album 2",
                            ArtistId = 2,
                            ReleaseDate = new DateTime(2024, 8, 22, 15, 31, 22, 172, DateTimeKind.Local).AddTicks(7655)
                        });
                });
            ...
            modelBuilder.Entity("Tunify_Platform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Join_Date = new DateTime(2024, 8, 22, 15, 31, 22, 172, DateTimeKind.Local).AddTicks(7608),
                            SubscriptionId = 1,
                            Username = "john_doe"
                        },
                        new
                        {
                            ...
                            Join_Date = new DateTime(2024, 8, 22, 15, 31, 22, 172, DateTimeKind.Local).AddTicks(7621),
                            SubscriptionId = 2,
                            Username = "jane_doe"
                        });
                });
